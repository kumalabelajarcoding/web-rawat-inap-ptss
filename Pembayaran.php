...
<head>
	<title> Pembayaran rumah sakit </title>
...
<body>
	<header>
		<?php
        function headeer() {
            echo "Sistem Pembayaran Rumah Sakit";
        }
        headeer();
        ?>
	</header>
					...
					<div id="namadokter">
						<table class="table2">
							...
							<tbody>
								...
								echo "<td><center><a class='btn btn-success badge-pill 'style=width:45px;border-radius:5px; href=\"Pembayaran_Edit.php?noregis=$res[noregis]\">Edit</a>  
